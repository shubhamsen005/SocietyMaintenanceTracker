...
export default function NivasaApp({initialView='dashboard',resident=false,userName='Shubham Sen'}:{initialView?:string;resident?:boolean;userName?:string}) {
      ...
      <aside className="sidebar">
        ...
        <div className="side-bottom">
          ...
          <div className="profile">
            <span className="avatar dark">{userName.split(/\s+/).map(part=>part[0]).join('').slice(0,2).toUpperCase()}</span>
            <span>{userName}<small>{resident?'Resident · B-402':'Facilities Manager'}</small></span>
